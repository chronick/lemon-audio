...
import { createMockUSBDevice, createMockDfuSettings, createStatusResponse, createStateResponse, } from "./helpers/mock-usb";
...
describe("DfuDevice", () => {
    ...
    describe("getFirstWritableSegment", () => {
        it("returns first writable segment from DfuSe descriptor", () => {
            const { dfu } = makeDevice({
                dfuseDescriptor: "@Flash/0x08000000/04*016Ka,01*064Kg",
            });
